...
const NAV_ITEMS = [
  ...
  { section: 'Coming Soon', items: [
    { route: null, label: 'Chat',           icon: '?', soon: true },
    { route: null, label: 'Documentation',  icon: '?', soon: true },
    { route: null, label: 'Security Scan',  icon: '?', soon: true },
    { route: null, label: 'Code Review',    icon: '?', soon: true },
    { route: null, label: 'Architecture',   icon: '?', soon: true },
  ]},
];
